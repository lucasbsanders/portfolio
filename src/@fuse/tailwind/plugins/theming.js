                    ...
                    customProps: {
                        background: {
                            light: {
                                ...
                                'bg-default'   : '#F5F5F5',
                                'bg-dialog'    : '#FFFFFF',
                                'bg-hover'     : chroma('#E0E0E0').alpha(0.12).css(),
                                'bg-status-bar': '#E0E0E0',
                                'bg-site-container' : '#E0E0E0',
                            },
                            dark : {
                                'bg-app-bar'   : '#1E1E1E',
                                'bg-card'      : '#333333',
                                ...
                                'bg-status-bar': '#1E1E1E',
                                'bg-site-container' : '#333333',
                            },
                        },
                        foreground: {
                            light: {
                                'text-default'  : '#333333', //colors.slate[800],
                                'text-secondary': '#555555', //colors.slate[500],
                                'text-hint'     : '#555555', //colors.slate[400],
                                'text-disabled' : colors.slate[400],
                                'border'        : '#E0E0E0', //colors.slate[200],
                                'divider'       : '#E0E0E0', //colors.slate[200],
                                'icon'          : '#555555', //colors.slate[500],
                                'mat-icon'      : '#555555', //colors.slate[500],
                            },
                            dark : {
                                'text-default'  : '#E0E0E0', //'#FFFFFF',
                                'text-secondary': '#B0B0B0', //colors.slate[400],
                                'text-hint'     : '#B0B0B0', //colors.slate[500],
                                'text-disabled' : colors.slate[600],
                                'border'        : '#333333', //chroma(colors.slate[100]).alpha(0.12).css(),
                                'divider'       : '#333333', //chroma(colors.slate[100]).alpha(0.12).css(),
                                'icon'          : '#B0B0B0', //colors.slate[400],
                                'mat-icon'      : '#B0B0B0', //colors.slate[400],
                            },
                        },
                    },
                },
